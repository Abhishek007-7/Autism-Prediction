...
with col1:
    ...
    with st.expander("See the plot"):     
        ...
        st.plotly_chart(fig, key="jaundice_chart")  # Unique key added
...
with col2:
    ...
    with st.expander("See the plot"):        
        ...
        fig.update_layout(height=500, width=200)
        st.plotly_chart(fig, key="cars_chart")  # Unique key added
...
with col1:
    ...
    with st.expander("See the plot"):     
        ...
        fig.update_layout(height=500, width=200)
        st.plotly_chart(fig, key="family_asd_chart")  # Unique key added
...
with col2:
    ...
    with st.expander("See the plot"):        
        ...
        fig.update_layout(height=500, width=200)
        st.plotly_chart(fig, key="srs_chart")  # Unique key added
